...
export default function MeetingDetail({ meeting, onClose }: MeetingDetailProps) {
  ...
  const [playerType, setPlayerType] = useState<"fixed" | "direct">("direct")
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {activeTab === "audio" && (
            <div className="p-4 bg-gray-800 rounded-lg">
              <div className="mb-4 flex justify-center space-x-4">
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    playerType === "direct" ? "bg-blue-600 text-white" : "bg-gray-700 text-gray-300"
                  }`}
                >
                  Reproductor Simple
                </button>
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    playerType === "fixed" ? "bg-blue-600 text-white" : "bg-gray-700 text-gray-300"
                  }`}
                >
              ...
              {playerType === "direct" ? <DirectDownloadPlayer /> : <FixedAudioPlayer />}
            </div>
          )}
        </div>
      </div>
