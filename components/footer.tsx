...
export function Footer() {
  ...
  // Si estamos en la página de login, no mostramos el footer
  if (pathname === "/login") {
    return null
  }
  ...
  if (isMobile) {
    return (
      <>
        ...
        <footer className="fixed bottom-0 left-0 right-0 bg-blue-900 text-white z-50 shadow-lg">
          <nav className="flex justify-around items-center h-16">
            <Link
              href="/"
              className={`flex flex-col items-center p-2 ${pathname === "/" ? "text-blue-300" : "text-white"}`}
            >
              <Home size={24} />
            ...
            <Link
              href="/dashboard"
              className={`flex flex-col items-center p-2 ${pathname === "/dashboard" ? "text-blue-300" : "text-white"}`}
            >
              <Calendar size={24} />
            ...
            <Link
              ...
              className={`flex flex-col items-center p-2 ${
                pathname === "/building-transcriptions" ? "text-blue-300" : "text-white"
              }`}
            >
              <FileText size={24} />
            ...
            <Link
              href="/profile"
              className={`flex flex-col items-center p-2 ${pathname === "/profile" ? "text-blue-300" : "text-white"}`}
            >
              <User size={24} />
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tutorials" className="text-gray-300 hover:text-white transition">
                  Tutoriales
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-gray-400 mt-2">© {new Date().getFullYear()} Juntify. Todos los derechos reservados.</p>
          </div>
